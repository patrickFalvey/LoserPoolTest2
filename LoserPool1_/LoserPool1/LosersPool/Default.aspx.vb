...
Public Class MyOptionsList
    ...
    Public Shared Function MyOptionsList1(mlpo As MyOptionsList, Ename As String) As MyPool
        ...
        Dim finalScoringUpdateFile = "scoringUpdateFinalWeek.xml"
        ...
        Try
            Using (_dbLoserPool)
                ...
                If queryTime(0).filedate = "3/10/2015" Then
                ...
                Dim fileTime = DateTime.Parse(CDate(queryTime(0).filetime) + " " + CDate(queryTime(0).filedate))
                ...
                If fWN > tW Then
                    For I = tW To fWN - 1
                        Dim scoringUpdateFile = fileDirectory + finalScoringUpdateFile + CStr(I)
                        Dim sUFXDocument = XDocument.Load(scoringUpdateFile)
                ...
                ' Exit if all games on schedule are finished

                If queryGameSchedule.Count = 0 Then
                    mlpo.weekNumber = thisWeek
                    myPool1.EName = Ename

                    Dim queryUser1 = (From user2 In _dbLoserPool.Users
                                            Select user2).ToList

                    For Each user1 In queryUser1
                        user1.OptionState = "SeasonEnd"
                    Next
                ...
                ' Update scores for games on the schedule
                ...
                ' Check to see if all games for week are finished
